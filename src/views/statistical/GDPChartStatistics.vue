  ...
  <div class="water-statistics">
    ...
    <el-dialog
      ...
      <div class="button-radio">
        ...
        <div class="radios">
          <el-checkbox size="mini" v-model="technology" label="科技" border></el-checkbox>
          <el-checkbox size="mini" v-model="agricultural" label="农业" border></el-checkbox>
          <el-checkbox size="mini" v-model="education" label="教育" border></el-checkbox>
          <el-checkbox size="mini" v-model="tax" label="税收" border></el-checkbox>
        </div>
      </div>
    </el-dialog>
  </div>
